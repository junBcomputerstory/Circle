...
export const SIGNUP_PW_LENGTH = { "isSuccess": false, "code": 2005, "message": "비밀번호는 6~20자리를 입력해주세요." };
export const SIGNUP_NICKNAME_EMPTY = { "isSuccess": false, "code": 2006, "message": "닉네임을 입력 해주세요." };
export const SIGNUP_NICKNAME_LENGTH = { "isSuccess": false, "code": 2007, "message": "닉네임은 최대 20자리를 입력해주세요." };
export const SIGNIN_ID_EMPTY = { "isSuccess": false, "code": 2008, "message": "아이디를 입력해주세요" };
export const SIGNIN_ID_LENGTH = { "isSuccess": false, "code": 2009, "message": "아이디는 30자리 미만으로 입력해주세요." };
export const SIGNIN_ID_ERROR_TYPE = { "isSuccess": false, "code": 2010, "message": "아이디의 형식을 정확하게 입력해주세요." };
