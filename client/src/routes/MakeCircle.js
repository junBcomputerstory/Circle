      ...
      <Container fluid style={{ backgroundColor: 'orange' }}>
        <div className="form-box">
          <div className="field1">
            ...
            <br />
            <input className="textinput" type="text" placeholder="써클 이름을 적어주세요" />
            <TitleText>제한조건을 설정해주세요</TitleText>
            <br />
            <textarea className="textinput" placeholder="제한조건을 적어주세요" />
            <TitleText>활동 장소를 설정해주세요</TitleText>
            <br />
            <input className="textinput" placeholder="활동장소를 적어주세요" />
            <TitleText>써클을 소개해주세요</TitleText>
            <textarea className="textinput" placeholder="써클 소개를 적어주세요" />
            ...
            <ImageSelectButton>
              <label>
                <div style={{ margin: 'auto', textAlign: 'center' }}>
                  {fileImage ? (
                    <img alt="sample" src={fileImage} style={{ margin: 'auto', width: '180px', height: '180px' }} />
                  ) : (
          ...
          <Button size="lg" style={{ marginTop: 20, width: 700 }} variant="dark">
            써클 만들기
          </Button>
        </div>
      </Container>
